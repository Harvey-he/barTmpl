...
define([], function () {
    ...
    var services = angular.module('routeResolverSignServices', []);

    //Must be a provider since it will be injected into module.config()
    services.provider('routeResolverSign', function () {
        ...
        this.routeConfig = function () {
            var viewsDirectory = '/partials/sign/views/',
                controllersDirectory = '/partials/sign/controllers/',
